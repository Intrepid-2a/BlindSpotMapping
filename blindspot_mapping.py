...
## path
main_path = "."
data_path = main_path + "/mapping_data/"
...
for hemifield in ['left', 'right']
    ...
    if hemifield == 'left':
        ...
        point = visual.Circle(win, size = [1,1], pos = [-7,-1], fillColor=[1,1,1], lineColor = None, units='deg')
    else:
    ...
    fixation = visual.ShapeStim(win, vertices = ((0, -2), (0, 2), (0,0), (-2, 0), (2, 0)), lineWidth = 2, units = 'pix', size = (10, 10), closeShape = False, lineColor = 'white')
    abort = False
